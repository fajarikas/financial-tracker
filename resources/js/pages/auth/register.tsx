                        ...
                        <div className="grid gap-6">
                            ...
                            >
                                <a href={google.url()}>
                                    ...
                                    >
                                        <path
                                            d="M12.48 10.92v3.28h7.84c-.24 1.84-.908 3.152-1.928 4.176-1.224 1.224-3.136 2.592-6.448 2.592-5.184 0-9.416-4.136-9.416-9.336s4.232-9.336 9.416-9.336c2.8 0 4.512 1.112 5.88 2.44l2.28-2.28C18.12 1.056 15.408 0 12.48 0 5.856 0 .424 5.384.424 12s5.432 12 12.056 12c3.576 0 6.264-1.176 8.368-3.352 2.16-2.16 2.848-5.224 2.848-7.696 0-.72-.056-1.44-.16-2.136z"
                                            fill="currentColor"
                                        />
                                    </svg>
                                    Sign in with Google
